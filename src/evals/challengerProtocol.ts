...
export const CHALLENGER_V8_PROTOCOL_ID = "infinite-v8-sandbox-hardened-heldout-r1-20260715";
export const CHALLENGER_V8_CALIBRATION_ID = "challenger-blind-judge-three-tier-sandbox-hardened-20260715";
...
export async function buildChallengerProtocolManifest(rootDir: string): Promise<ChallengerProtocolManifest> {
  ...
  return {
    protocolId: CHALLENGER_V8_PROTOCOL_ID,
